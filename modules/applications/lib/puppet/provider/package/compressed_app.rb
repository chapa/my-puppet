# source : https://github.com/boxen/puppet-boxen/blob/master/lib/puppet/provider/package/compressed_app.rb
...
:parent => Puppet::Provider::Package do
  ...
  def install
    ...
    FileUtils.mkdir_p '/opt/my-puppet/cache'
...
private
  ...
  def cached_path
    "/opt/my-puppet/cache/#{@resource[:name]}.app.#{flavor}"
  end
